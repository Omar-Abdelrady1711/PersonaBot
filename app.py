...
st.info(
    ...
    f"**Active persona:** `{st.session_state.selected_preset}` — "
    ...
    with st.form("chat_form", clear_on_submit=True):
        ...
        with c1:
            user_input = st.text_input("", "",
                placeholder="Type your message… or try an adversarial message from the sidebar",
                label_visibility="collapsed")
        with c2:
    ...
    if submitted and user_input.strip():
        ...
        with st.spinner("Thinking…"):
            ...
            if condition in ("adaptive", "adaptive_reinforce"):
                ...
                # Only inject correction in adaptive_reinforce
...
with panel_col:
    ...
    if history:
        ...
        if scores:
            ...
            st.caption("No alignment data — switch to Adaptive condition.")
    else:
